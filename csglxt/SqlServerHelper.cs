...
public class SqlServerHelper
{
    ...
    public static string ConStr_master
    {
        get
        {
            string conStr = ConfigurationManager.ConnectionStrings["csglxtConStr"].ConnectionString;
            //解析字符串切勿删除或改名
    ...
    {
        //初始化数据库链接字符串，从web.config里面获取节点【csglxtConStr】的链接字符串
        conStr = ConfigurationManager.ConnectionStrings["csglxtConStr"].ConnectionString;
    }
