<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registe.aspx.cs" Inherits="csglxt.Registe" %>
        ...
        <div class="login-body">
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tbNameCN" runat="server"></asp:TextBox>
                        <span style="color:red">*</span>
                    </td>
                </tr>
                <tr>
                    <td></td>
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="姓名不能为空" ForeColor="Red" ControlToValidate="tbNameCN"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td>
